SERVICE = eapearson_groupedparameterstest
SERVICE_CAPS = eapearson_GroupedParametersTest
SPEC_FILE = eapearson_GroupedParametersTest.spec
URL = https://kbase.us/services/eapearson_groupedparameterstest
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
