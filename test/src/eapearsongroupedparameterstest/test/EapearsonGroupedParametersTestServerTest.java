package eapearsongroupedparameterstest.test;
...
import eapearsongroupedparameterstest.EapearsonGroupedParametersTestServer;
...
public class EapearsonGroupedParametersTestServerTest {
    private static AuthToken token = null;
    private static Map<String, String> config = null;
    private static WorkspaceClient wsClient = null;
    private static String wsName = null;
    private static EapearsonGroupedParametersTestServer impl = null;
    ...
    public static void init() throws Exception {
        ...
        config = ini.get("eapearson_GroupedParametersTest");
        ...
        impl = new EapearsonGroupedParametersTestServer();
    }
    
    private static String getWsName() throws Exception {
        if (wsName == null) {
            long suffix = System.currentTimeMillis();
            wsName = "test_EapearsonGroupedParametersTest_" + suffix;
    ...
    private static RpcContext getContext() {
        return new RpcContext().withProvenance(Arrays.asList(new ProvenanceAction()
            .withService("eapearson_GroupedParametersTest").withMethod("please_never_use_it_in_production")
